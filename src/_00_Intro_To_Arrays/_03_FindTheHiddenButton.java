...
public class _03_FindTheHiddenButton implements ActionListener{
    ...
    public void start() {
        ...
        String posint = JOptionPane.showInputDialog("Please enter a positive integer.");
        int usableposint = Integer.parseInt(posint);

        // 4. Initialize the array of JButtons to be the size of the int
        //    created in step 3
        
        buttons = new JButton[usableposint];

        // 5. Make a for loop to iterate through the JButton array
        
        for(int i = 0; i < usableposint; i++) {
        ...
        // 12. Give the user the instructions for the game.
        	JOptionPane.showMessageDialog(null, "Please click on the hidden button. Have fun!");
        // 13. initialize the hiddenButton variable to a random number less than
        //     the int created in step 3
        	Random ran = new Random();
        	hiddenButton = ran.nextInt(usableposint);
