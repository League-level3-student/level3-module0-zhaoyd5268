...
public class WorldPanel extends JPanel implements MouseListener, ActionListener {
	...
	public WorldPanel(int w, int h, int cpr) {
        ...
        //    passing in the location.
  			for(int i = 0; i < array2d[cpr-1].length; i++) {
      			for(int j = 0; j < array2d[cpr-1].length; j++) {
	...
	public void randomizeCells() {
		...
		for(int i = 0; i < array2d[cellsPerRow-1].length; i++) {
  			for(int j = 0; j < array2d[cellsPerRow-1].length; j++) {
	...
	public void mousePressed(MouseEvent e) {
		...
		int Px = e.getX()/cellSize;
		int Py = e.getY()/cellSize;
		if (array2d[Px][Py].isAlive == false) {
			array2d[Px][Py].isAlive = true;
		} else {
			array2d[Px][Py].isAlive = false;
		}
